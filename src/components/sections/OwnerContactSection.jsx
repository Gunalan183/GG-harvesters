  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div style={{ position: 'absolute', top: '-4rem', right: '-4rem', width: '18rem', height: '18rem', borderRadius: '50%', background: 'rgba(212,160,23,0.07)' }} />
        <div style={{ position: 'absolute', bottom: '-3rem', left: '-3rem', width: '14rem', height: '14rem', borderRadius: '50%', background: 'rgba(255,255,255,0.04)' }} />
      </div>
      ...
      <div className="container-site relative z-10" style={{ padding: '3.5rem 1rem 0 1rem' }}>
        ...
        <div className="text-center" style={{ marginBottom: '2.5rem' }}>
          <span
            ...
            style={{ background: 'rgba(212,160,23,0.18)', border: '1px solid rgba(212,160,23,0.45)', color: '#f0cc5a', padding: '0.3rem 1rem', marginBottom: '0.85rem' }}
          >
            {t.badge}
          </span>
          <h2
          ...
          >
            {t.heading} <span style={{ color: '#f0cc5a' }}>{t.headingHighlight}</span>
          </h2>
          <p
            className="text-white/65 mx-auto leading-relaxed"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <div className="flex flex-col gap-3">
            {BUSINESS.phones.map((phone, i) => (
              <a
                ...
                style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.14)', backdropFilter: 'blur(10px)', padding: '1rem 1.25rem' }}
                aria-label={`Call ${phone}`}
              >
                <span
                  className="flex items-center justify-center rounded-full flex-shrink-0"
                  style={{ width: '2.5rem', height: '2.5rem', background: 'linear-gradient(135deg, #d4a017, #f0cc5a)' }}
                >
                  <Phone size={15} className="text-[#1a2e1a]" />
                </span>
                <div>
                  <p className="text-white/50 text-[0.65rem] font-semibold uppercase tracking-wider">
                    {i === 0 ? t.primaryPhone : t.altPhone}
                  </p>
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 font-bold rounded-2xl transition-all active:scale-95"
              style={{ background: '#25d366', color: '#fff', padding: '0.9rem 1.25rem', fontSize: '0.9rem', boxShadow: '0 4px 18px rgba(37,211,102,0.4)' }}
            >
          ...
          <div
            ...
            style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.13)', backdropFilter: 'blur(10px)', padding: '1.5rem' }}
          >
            <div className="flex items-start gap-3" style={{ marginBottom: '1.5rem' }}>
              ...
              <div>
                <p className="text-white/50 text-[0.65rem] font-semibold uppercase tracking-wider" style={{ marginBottom: '0.4rem' }}>
                  {t.addressLabel}
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white font-medium text-sm">
                  {t.hoursLine1}<br />
                  <span style={{ color: '#f0cc5a' }}>{t.hoursLine2}</span>
                </p>
              </div>
            </div>
          </div>
