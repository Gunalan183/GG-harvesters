...
export const SERVICES = [
  ...
  },
  {
    ...
    image: '/images/services/gg-tractor-service-kumbakonam.jpg',
  ...
  },
  {
    ...
    slug: 'jcb-3cx',
    icon: '🏗️',
    nameTamil: 'JCB 3CX Backhoe Loader சேவை',
    nameEnglish: 'JCB 3CX Backhoe Loader',
    shortDesc: 'கட்டுமான மற்றும் மண் பணிகளுக்கு பல்நோக்கு JCB 3CX Backhoe Loader சேவை.',
    shortDescEnglish: 'Versatile JCB 3CX Backhoe Loader for construction and earthwork.',
    image: '/images/services/gg-jcb-3cx-service-kumbakonam.jpg',
    altText: 'GG JCB 3CX backhoe loader working on earthmoving project near Kumbakonam Thanjavur',
    whatsappMsg: 'வணக்கம் GG Harvester, எனக்கு JCB 3CX Backhoe Loader சேவை தேவை. வேலை நடைபெறும் இடம்: ______',
    seoTitle: 'JCB 3CX Backhoe Loader Service in Kumbakonam | GG',
    metaDesc: 'GG Harvester and Earth Movers — JCB 3CX Backhoe Loader சேவை Kumbakonam & Thanjavur பகுதியில். கட்டுமானம், மண் பணிகள், குழி தோண்டல். 📞 8608522042.',
    applications: [
      'குழி தோண்டல்',
      'கட்டுமான அடிப்படை பணிகள்',
      'மண் அகற்றல்',
      'ரோடு பணிகள்',
    ],
    color: 'gold',
  },
  {
    ...
    image: '/images/services/gg-jcb-mini-excavator-service-thanjavur.jpg',
...
export const NAV_LINKS = [
  { label: 'முகப்பு', labelEn: 'Home', path: '/' },
  ...
  { label: 'எங்களைப் பற்றி', labelEn: 'About', path: '/about' },
  { label: 'தொடர்புக்கு', labelEn: 'Contact', path: '/contact' },
];

export const MOBILE_NAV = [
  { label: 'முகப்பு', icon: 'Home', path: '/' },
